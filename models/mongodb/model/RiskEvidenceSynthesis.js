...
module.exports = function() {
    ...
    RiskEvidenceSynthesisSchema.pre('save', async function(next) {
        ...
        const docInHistory = await mongodb.RiskEvidenceSynthesis_history.findOne({
                id: this.id
            })
            .sort({
                "meta.versionId": -1
    ...
    RiskEvidenceSynthesisSchema.post('save', async function(result) {
        ...
        if (version == "1") {
            ...
            let createdDocs = await mongodb['RiskEvidenceSynthesis_history'].create(item);
        } else {
            _.set(item, "request", {
                "method": "PUT",
                url: `http://${process.env.FHIRSERVER_HOST}${port}/${process.env.FHIRSERVER_APIPATH}/RiskEvidenceSynthesis/${item.id}/_history/${version}`
    ...
    RiskEvidenceSynthesisSchema.post('findOneAndUpdate', async function(result) {
        ...
        try {
            let history = await mongodb['RiskEvidenceSynthesis_history'].create(item);
        } catch (e) {
            console.error(e);
        }
    ...
    const RiskEvidenceSynthesisModel = mongoose.model("RiskEvidenceSynthesis", RiskEvidenceSynthesisSchema, "RiskEvidenceSynthesis");
