...
module.exports = function() {
    ...
    const LibraryHistorySchema = new mongoose.Schema(Library, schemaConfig);
    ...
    const LibraryHistoryModel = mongoose.model("Library_history", LibraryHistorySchema, "Library_history");
