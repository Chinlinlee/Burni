...
module.exports = function(connection = mongoose) {
    ...
    EffectEvidenceSynthesisSchema.pre('save', async function(next) {
        ...
        const docInHistory = await mongodb.model("EffectEvidenceSynthesis_history").findOne({
                id: this.id
            })
            .sort({
                "meta.versionId": -1
    ...
    EffectEvidenceSynthesisSchema.post('save', async function(result) {
        ...
        if (version == "1") {
            ...
            let createdDocs = await mongodb.model("EffectEvidenceSynthesis_history").create(item);
        } else {
            _.set(item, "request", {
                "method": "PUT",
                url: `http://${process.env.FHIRSERVER_HOST}${port}/${process.env.FHIRSERVER_APIPATH}/EffectEvidenceSynthesis/${item.id}/_history/${version}`
    ...
    EffectEvidenceSynthesisSchema.post('findOneAndUpdate', async function(result) {
        ...
        try {
            let history = await modelConnection.model("EffectEvidenceSynthesis_history").create(item);
        } catch (e) {
            console.error(e);
        }
    ...
    EffectEvidenceSynthesisSchema.pre('findOneAndDelete', async function(next) {
        ...
        let createdDocs = await modelConnection.model("EffectEvidenceSynthesis_history").create(item);
        next();
    });
    ...
    const EffectEvidenceSynthesisModel = modelConnection.model("EffectEvidenceSynthesis", EffectEvidenceSynthesisSchema, "EffectEvidenceSynthesis");
