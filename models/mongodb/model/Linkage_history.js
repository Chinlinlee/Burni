...
module.exports = function() {
    ...
    const LinkageHistorySchema = new mongoose.Schema(Linkage, schemaConfig);
    ...
    const LinkageHistoryModel = mongoose.model("Linkage_history", LinkageHistorySchema, "Linkage_history");
