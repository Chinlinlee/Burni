...
module.exports = function() {
    ...
    const DeviceHistorySchema = new mongoose.Schema(Device, schemaConfig);
    ...
    const DeviceHistoryModel = mongoose.model("Device_history", DeviceHistorySchema, "Device_history");
