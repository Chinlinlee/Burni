...
module.exports = function(connection = mongoose) {
    ...
    MedicinalProductManufacturedSchema.pre('save', async function(next) {
        ...
        const docInHistory = await mongodb.model("MedicinalProductManufactured_history").findOne({
                id: this.id
            })
            .sort({
                "meta.versionId": -1
    ...
    MedicinalProductManufacturedSchema.post('save', async function(result) {
        ...
        if (version == "1") {
            ...
            let createdDocs = await mongodb.model("MedicinalProductManufactured_history").create(item);
        } else {
            _.set(item, "request", {
                "method": "PUT",
                url: `http://${process.env.FHIRSERVER_HOST}${port}/${process.env.FHIRSERVER_APIPATH}/MedicinalProductManufactured/${item.id}/_history/${version}`
    ...
    MedicinalProductManufacturedSchema.post('findOneAndUpdate', async function(result) {
        ...
        try {
            let history = await modelConnection.model("MedicinalProductManufactured_history").create(item);
        } catch (e) {
            console.error(e);
        }
    ...
    MedicinalProductManufacturedSchema.pre('findOneAndDelete', async function(next) {
        ...
        let createdDocs = await modelConnection.model("MedicinalProductManufactured_history").create(item);
        next();
    });
    ...
    const MedicinalProductManufacturedModel = modelConnection.model("MedicinalProductManufactured", MedicinalProductManufacturedSchema, "MedicinalProductManufactured");
