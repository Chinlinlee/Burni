...
module.exports = function(connection = mongoose) {
    ...
    CoverageEligibilityResponse.bundleRequest = {
        "type": Object,
        "method": {
            type: String,
            required: true
    ...
    CoverageEligibilityResponse.bundleResponse = {
        "type": Object,
        "status": {
            type: String,
            required: true
    ...
    CoverageEligibilityResponseHistorySchema.methods.getFHIRBundleField = function() {
        let result = this.toObject();
        delete result._id;
        delete result.__v;
