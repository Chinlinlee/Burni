...
const { Coding } = require("../FHIRDataTypesSchema/Coding");
const { Quantity } = require("../FHIRDataTypesSchema/Quantity");
const { Duration } = require("../FHIRDataTypesSchema/Duration");
const { Distance } = require("../FHIRDataTypesSchema/Distance");
const { Count } = require("../FHIRDataTypesSchema/Count");
const { Money } = require("../FHIRDataTypesSchema/Money");
const { Age } = require("../FHIRDataTypesSchema/Age");
const { Range } = require("../FHIRDataTypesSchema/Range");
const { Period } = require("../FHIRDataTypesSchema/Period");
const { Ratio } = require("../FHIRDataTypesSchema/Ratio");
const { Reference } = require("../FHIRDataTypesSchema/Reference");
const { SampledData } = require("../FHIRDataTypesSchema/SampledData");
const { Signature } = require("../FHIRDataTypesSchema/Signature");
...
const { Timing } = require("../FHIRDataTypesSchema/Timing");
const { Timing_Repeat } = require("../FHIRDataTypesSchema/Timing_Repeat");
const { Meta } = require("../FHIRDataTypesSchema/Meta");
const { ContactDetail } = require("../FHIRDataTypesSchema/ContactDetail");
const { Contributor } = require("../FHIRDataTypesSchema/Contributor");
const { DataRequirement } = require("../FHIRDataTypesSchema/DataRequirement");
const {
...
const { RelatedArtifact } = require("../FHIRDataTypesSchema/RelatedArtifact");
const {
    TriggerDefinition
} = require("../FHIRDataTypesSchema/TriggerDefinition");
const { UsageContext } = require("../FHIRDataTypesSchema/UsageContext");
const { Dosage } = require("../FHIRDataTypesSchema/Dosage");
const {
    Dosage_DoseAndRate
} = require("../FHIRDataTypesSchema/Dosage_DoseAndRate");
const { Population } = require("../FHIRDataTypesSchema/Population");
const { ProductShelfLife } = require("../FHIRDataTypesSchema/ProductShelfLife");
const {
    ProdCharacteristic
} = require("../FHIRDataTypesSchema/ProdCharacteristic");
const { MarketingStatus } = require("../FHIRDataTypesSchema/MarketingStatus");
const { SubstanceAmount } = require("../FHIRDataTypesSchema/SubstanceAmount");
const {
    SubstanceAmount_ReferenceRange
} = require("../FHIRDataTypesSchema/SubstanceAmount_ReferenceRange");
const { Expression } = require("../FHIRDataTypesSchema/Expression");
const {
    ElementDefinition
...
const { Account_Coverage } = require("../FHIRDataTypesSchema/Account_Coverage");
const {
    Account_Guarantor
...
const { AuditEvent_Agent } = require("../FHIRDataTypesSchema/AuditEvent_Agent");
const {
    AuditEvent_Network
...
const { Bundle_Link } = require("../FHIRDataTypesSchema/Bundle_Link");
const { Bundle_Entry } = require("../FHIRDataTypesSchema/Bundle_Entry");
const { Bundle_Search } = require("../FHIRDataTypesSchema/Bundle_Search");
const { Bundle_Request } = require("../FHIRDataTypesSchema/Bundle_Request");
const { Bundle_Response } = require("../FHIRDataTypesSchema/Bundle_Response");
const {
...
const { CarePlan_Detail } = require("../FHIRDataTypesSchema/CarePlan_Detail");
const {
...
const { Claim_Related } = require("../FHIRDataTypesSchema/Claim_Related");
const { Claim_Payee } = require("../FHIRDataTypesSchema/Claim_Payee");
const { Claim_CareTeam } = require("../FHIRDataTypesSchema/Claim_CareTeam");
const {
    Claim_SupportingInfo
} = require("../FHIRDataTypesSchema/Claim_SupportingInfo");
const { Claim_Diagnosis } = require("../FHIRDataTypesSchema/Claim_Diagnosis");
const { Claim_Procedure } = require("../FHIRDataTypesSchema/Claim_Procedure");
const { Claim_Insurance } = require("../FHIRDataTypesSchema/Claim_Insurance");
const { Claim_Accident } = require("../FHIRDataTypesSchema/Claim_Accident");
const { Claim_Item } = require("../FHIRDataTypesSchema/Claim_Item");
const { Claim_Detail } = require("../FHIRDataTypesSchema/Claim_Detail");
const { Claim_SubDetail } = require("../FHIRDataTypesSchema/Claim_SubDetail");
const {
    ClaimResponse_Item
...
const { ConceptMap_Group } = require("../FHIRDataTypesSchema/ConceptMap_Group");
const {
    ConceptMap_Element
...
const { Condition_Stage } = require("../FHIRDataTypesSchema/Condition_Stage");
const {
    Condition_Evidence
} = require("../FHIRDataTypesSchema/Condition_Evidence");
const { Consent_Policy } = require("../FHIRDataTypesSchema/Consent_Policy");
const {
...
const { Consent_Actor } = require("../FHIRDataTypesSchema/Consent_Actor");
const { Consent_Data } = require("../FHIRDataTypesSchema/Consent_Data");
const {
    Contract_ContentDefinition
} = require("../FHIRDataTypesSchema/Contract_ContentDefinition");
const { Contract_Term } = require("../FHIRDataTypesSchema/Contract_Term");
const {
    Contract_SecurityLabel
} = require("../FHIRDataTypesSchema/Contract_SecurityLabel");
const { Contract_Offer } = require("../FHIRDataTypesSchema/Contract_Offer");
const { Contract_Party } = require("../FHIRDataTypesSchema/Contract_Party");
const { Contract_Answer } = require("../FHIRDataTypesSchema/Contract_Answer");
const { Contract_Asset } = require("../FHIRDataTypesSchema/Contract_Asset");
const { Contract_Context } = require("../FHIRDataTypesSchema/Contract_Context");
const {
    Contract_ValuedItem
} = require("../FHIRDataTypesSchema/Contract_ValuedItem");
const { Contract_Action } = require("../FHIRDataTypesSchema/Contract_Action");
const { Contract_Subject } = require("../FHIRDataTypesSchema/Contract_Subject");
const { Contract_Signer } = require("../FHIRDataTypesSchema/Contract_Signer");
const {
    Contract_Friendly
} = require("../FHIRDataTypesSchema/Contract_Friendly");
const { Contract_Legal } = require("../FHIRDataTypesSchema/Contract_Legal");
const { Contract_Rule } = require("../FHIRDataTypesSchema/Contract_Rule");
const { Coverage_Class } = require("../FHIRDataTypesSchema/Coverage_Class");
const {
...
const { Device_Version } = require("../FHIRDataTypesSchema/Device_Version");
const { Device_Property } = require("../FHIRDataTypesSchema/Device_Property");
const {
...
const { Goal_Target } = require("../FHIRDataTypesSchema/Goal_Target");
const {
...
const { Group_Member } = require("../FHIRDataTypesSchema/Group_Member");
const {
...
const { Invoice_LineItem } = require("../FHIRDataTypesSchema/Invoice_LineItem");
const {
    Invoice_PriceComponent
} = require("../FHIRDataTypesSchema/Invoice_PriceComponent");
const { Linkage_Item } = require("../FHIRDataTypesSchema/Linkage_Item");
const { List_Entry } = require("../FHIRDataTypesSchema/List_Entry");
const {
    Location_Position
...
const { Measure_Group } = require("../FHIRDataTypesSchema/Measure_Group");
const {
    Measure_Population
...
const { Medication_Batch } = require("../FHIRDataTypesSchema/Medication_Batch");
const {
...
const { Person_Link } = require("../FHIRDataTypesSchema/Person_Link");
const {
    PlanDefinition_Goal
...
const { Provenance_Agent } = require("../FHIRDataTypesSchema/Provenance_Agent");
const {
    Provenance_Entity
...
const { Task_Restriction } = require("../FHIRDataTypesSchema/Task_Restriction");
const { Task_Input } = require("../FHIRDataTypesSchema/Task_Input");
const { Task_Output } = require("../FHIRDataTypesSchema/Task_Output");
const {
...
const { TestReport_Setup } = require("../FHIRDataTypesSchema/TestReport_Setup");
const {
    TestReport_Action
...
const { TestReport_Test } = require("../FHIRDataTypesSchema/TestReport_Test");
const {
    TestReport_Action1
...
const { TestScript_Link } = require("../FHIRDataTypesSchema/TestScript_Link");
const {
...
const { TestScript_Setup } = require("../FHIRDataTypesSchema/TestScript_Setup");
const {
    TestScript_Action
...
const { TestScript_Test } = require("../FHIRDataTypesSchema/TestScript_Test");
const {
    TestScript_Action1
...
const { ValueSet_Compose } = require("../FHIRDataTypesSchema/ValueSet_Compose");
const { ValueSet_Include } = require("../FHIRDataTypesSchema/ValueSet_Include");
const { ValueSet_Concept } = require("../FHIRDataTypesSchema/ValueSet_Concept");
const {
    ValueSet_Designation
} = require("../FHIRDataTypesSchema/ValueSet_Designation");
const { ValueSet_Filter } = require("../FHIRDataTypesSchema/ValueSet_Filter");
const {
    ValueSet_Expansion
