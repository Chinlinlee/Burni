...
(function (Severities) {
    ...
    Severities["Information"] = "information";
...
class Validator {
    ...
    ;
    validateValueSet(property, obj, treeDisplay) {
        /*let message = {
            treeDisplay : "" , 
            msg : "",
            isFound: false ,
        ...
        let messageList = [];
        let doValidateValueSet = (_valueSet , _valueSetStrength) => {
            let valueSetUrl = _valueSet;
            ...
            if (!foundValueSet) {
                this.addInfo(treeDisplay, 'Value set "' + _valueSet + '" could not be found.');
            }
            else {
    ...
    validateNext(obj, property, tree) {
        ...
        this.validateValueSet(property, obj, treeDisplay);
        // if (property._valueSet) {
