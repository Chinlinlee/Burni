---
title: "Configuration"
description: "Burni v3 resource configuration, environment variables, and code generation"
---
...
## 1. Create and Edit `config/config.js`
...
### Example `config/config.js` Structure
