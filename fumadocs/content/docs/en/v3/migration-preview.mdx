---
title: "Migration Preview: Upgrading from v2 to v3"
description: "Guidelines, environment requirements, dual database setup, and temporal migration steps from Burni v2 to v3"
---
