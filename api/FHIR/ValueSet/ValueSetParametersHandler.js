...
//#region code
paramsSearchFields["code"] = ["expansion.contains.code", "compose.include.concept.code"];
const codeSearchFunc = {};
codeSearchFunc["expansion.contains.code"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

codeSearchFunc["compose.include.concept.code"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};
