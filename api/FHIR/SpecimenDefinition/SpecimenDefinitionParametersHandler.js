...
//#region container
paramsSearchFields["container"] = ["typeTested.container.type"];
const containerSearchFunc = {};
containerSearchFunc["typeTested.container.type"] = (item, field) => {
...
//#endregion
//#region type
paramsSearchFields["type"] = ["typeCollected"];
const typeSearchFunc = {};
typeSearchFunc["typeCollected"] = (item, field) => {
    return queryBuild.tokenQuery(item, "coding.code", field, "", true);
};
