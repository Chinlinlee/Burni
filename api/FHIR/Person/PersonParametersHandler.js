...
//#endregion
//#region link
paramsSearchFields["link"] = ["link.target.reference"];
...
//#endregion
//#region patient
paramsSearchFields["patient"] = ["link.target.reference"];
...
//#endregion
//#region practitioner
paramsSearchFields["practitioner"] = ["link.target.reference"];
...
paramsSearchFields["relatedperson"] = ["link.target.reference"];
paramsSearch["relatedperson"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "relatedperson");
    } catch (e) {
        console.error(e);
        throw e;
    }
