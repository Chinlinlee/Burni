...
paramsSearchFields["communication"] = ["communication"];
const communicationSearchFunc = {};
communicationSearchFunc["communication"] = (item, field) => {
    return queryBuild.tokenQuery(item, "coding.code", field, "", true);
};

paramsSearch["communication"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "communication", communicationSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
