...
//#region datewritten
paramsSearchFields["datewritten"] = ["dateWritten"];
const datewrittenSearchFunc = {};
datewrittenSearchFunc["dateWritten"] = (value, field) => {
    return queryBuild.dateTimeQuery(value, field);
};

paramsSearch["datewritten"] = (query) => {
    try {
        queryHandler.getPolyDateQuery(query, paramsSearchFields, "datewritten", datewrittenSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region prescriber
paramsSearchFields["prescriber"] = ["prescriber.reference"];
paramsSearch["prescriber"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "prescriber");
    } catch (e) {
        console.error(e);
        throw e;
    }
