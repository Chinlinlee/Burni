...
//#endregion
//#region testscript-capability
paramsSearchFields["testscript-capability"] = ["metadata.capability.description"];
paramsSearchFields["testscript-capability:contains"] = paramsSearchFields["testscript-capability"];
paramsSearchFields["testscript-capability:exact"] = paramsSearchFields["testscript-capability"];
paramsSearch["testscript-capability"] = (query) => {
    try {
        queryHandler.getStringQuery(query, paramsSearchFields, "testscript-capability");
    } catch (e) {
        console.error(e);
        throw e;
    }
};
paramsSearch["testscript-capability:contains"] = (query) => {
    try {
        queryHandler.getStringQuery(query, paramsSearchFields, "testscript-capability:contains");
    } catch (e) {
        console.error(e);
        throw e;
    }
};
paramsSearch["testscript-capability:exact"] = (query) => {
    try {
        queryHandler.getStringQuery(query, paramsSearchFields, "testscript-capability:exact");
    } catch (e) {
        console.error(e);
        throw e;
    }
