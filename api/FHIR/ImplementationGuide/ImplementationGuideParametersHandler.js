...
//#endregion
//#region depends-on
paramsSearchFields["depends-on"] = ["dependsOn.uri.reference"];
paramsSearch["depends-on"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "depends-on");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region global
paramsSearchFields["global"] = ["global.profile.reference"];
paramsSearch["global"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "global");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region resource
paramsSearchFields["resource"] = ["definition.resource.reference.reference"];
paramsSearch["resource"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "resource");
    } catch (e) {
        console.error(e);
        throw e;
    }
