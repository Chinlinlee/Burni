...
//#endregion
//#region payment-issuer
paramsSearchFields["payment-issuer"] = ["paymentIssuer.reference"];
paramsSearch["payment-issuer"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "payment-issuer");
    } catch (e) {
        console.error(e);
        throw e;
    }
