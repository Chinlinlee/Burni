...
//#endregion
//#region fhirversion
paramsSearchFields["fhirversion"] = ["version"];
const fhirversionSearchFunc = {};
fhirversionSearchFunc["version"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

paramsSearch["fhirversion"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "fhirversion", fhirversionSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region format
paramsSearchFields["format"] = ["format"];
const formatSearchFunc = {};
formatSearchFunc["format"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};
...
//#endregion
//#region guide
paramsSearchFields["guide"] = ["implementationGuide.reference"];
paramsSearch["guide"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "guide");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region mode
paramsSearchFields["mode"] = ["rest.mode"];
const modeSearchFunc = {};
modeSearchFunc["rest.mode"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

paramsSearch["mode"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "mode", modeSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region resource
paramsSearchFields["resource"] = ["rest.resource.type"];
const resourceSearchFunc = {};
resourceSearchFunc["rest.resource.type"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

paramsSearch["resource"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "resource", resourceSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region resource-profile
paramsSearchFields["resource-profile"] = ["rest.resource.profile.reference"];
paramsSearch["resource-profile"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "resource-profile");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
paramsSearchFields["security-service"] = ["rest.security.service"];
const security_serviceSearchFunc = {};
security_serviceSearchFunc["rest.security.service"] = (item, field) => {
    return queryBuild.tokenQuery(item, "coding.code", field, "", true);
};

paramsSearch["security-service"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "security-service", security_serviceSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region software
paramsSearchFields["software"] = ["software.name"];
paramsSearchFields["software:contains"] = paramsSearchFields["software"];
paramsSearchFields["software:exact"] = paramsSearchFields["software"];
paramsSearch["software"] = (query) => {
    try {
        queryHandler.getStringQuery(query, paramsSearchFields, "software");
    } catch (e) {
        console.error(e);
        throw e;
    }
};
paramsSearch["software:contains"] = (query) => {
    try {
        queryHandler.getStringQuery(query, paramsSearchFields, "software:contains");
    } catch (e) {
        console.error(e);
        throw e;
    }
};
paramsSearch["software:exact"] = (query) => {
    try {
        queryHandler.getStringQuery(query, paramsSearchFields, "software:exact");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region supported-profile
paramsSearchFields["supported-profile"] = ["rest.resource.supportedProfile.reference"];
paramsSearch["supported-profile"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "supported-profile");
    } catch (e) {
        console.error(e);
        throw e;
    }
