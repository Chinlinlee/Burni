...
//#endregion
//#region claim
paramsSearchFields["claim"] = ["claim.reference"];
paramsSearch["claim"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "claim");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region coverage
paramsSearchFields["coverage"] = ["insurance.coverage.reference"];
paramsSearch["coverage"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "coverage");
    } catch (e) {
        console.error(e);
        throw e;
    }
