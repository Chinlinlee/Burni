...
//#endregion
//#region definition
paramsSearchFields["definition"] = ["action.definition.reference"];
paramsSearch["definition"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "definition");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region depends-on
paramsSearchFields["depends-on"] = ["relatedArtifact.resource", "library.reference"];
