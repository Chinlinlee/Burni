...
//#endregion
//#region request
paramsSearchFields["request"] = ["requestIdentifier"];
const requestSearchFunc = {};
requestSearchFunc["requestIdentifier"] = (item, field) => {
    return queryBuild.tokenQuery(item, "value", field, "", false);
};

paramsSearch["request"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "request", requestSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
