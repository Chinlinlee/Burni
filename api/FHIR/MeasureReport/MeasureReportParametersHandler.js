...
//#endregion
//#region evaluated-resource
paramsSearchFields["evaluated-resource"] = ["evaluatedResource.reference"];
paramsSearch["evaluated-resource"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "evaluated-resource");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region measure
paramsSearchFields["measure"] = ["measure.reference"];
paramsSearch["measure"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "measure");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region period
paramsSearchFields["period"] = ["period"];
const periodSearchFunc = {};
periodSearchFunc["period"] = (value, field) => {
...
//#endregion
//#region reporter
paramsSearchFields["reporter"] = ["reporter.reference"];
paramsSearch["reporter"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "reporter");
    } catch (e) {
        console.error(e);
        throw e;
    }
