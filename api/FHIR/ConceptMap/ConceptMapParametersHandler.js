...
//#endregion
//#region other
paramsSearchFields["other"] = ["group.unmapped.url.reference"];
paramsSearch["other"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "other");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region source
paramsSearchFields["source"] = ["sourceCanonical.reference"];
...
//#endregion
//#region source-code
paramsSearchFields["source-code"] = ["group.element.code"];
const source_codeSearchFunc = {};
source_codeSearchFunc["group.element.code"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

paramsSearch["source-code"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "source-code", source_codeSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region source-uri
paramsSearchFields["source-uri"] = ["sourceUri.reference"];
paramsSearch["source-uri"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "source-uri");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region target
paramsSearchFields["target"] = ["targetCanonical.reference"];
...
//#endregion
//#region target-code
paramsSearchFields["target-code"] = ["group.element.target.code"];
const target_codeSearchFunc = {};
target_codeSearchFunc["group.element.target.code"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

paramsSearch["target-code"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "target-code", target_codeSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region target-uri
paramsSearchFields["target-uri"] = ["targetUri.reference"];
paramsSearch["target-uri"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "target-uri");
    } catch (e) {
        console.error(e);
        throw e;
    }
