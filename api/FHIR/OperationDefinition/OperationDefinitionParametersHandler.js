...
//#region base
paramsSearchFields["base"] = ["base.reference"];
...
paramsSearchFields["input-profile"] = ["inputProfile.reference"];
paramsSearch["input-profile"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "input-profile");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region instance
paramsSearchFields["instance"] = ["instance"];
const instanceSearchFunc = {};
instanceSearchFunc["instance"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};
...
paramsSearchFields["output-profile"] = ["outputProfile.reference"];
paramsSearch["output-profile"] = (query) => {
    try {
        queryHandler.getReferenceQuery(query, paramsSearchFields, "output-profile");
    } catch (e) {
        console.error(e);
        throw e;
    }
...
//#endregion
//#region system
paramsSearchFields["system"] = ["system"];
const systemSearchFunc = {};
systemSearchFunc["system"] = (item, field) => {
    return queryBuild.tokenQuery(item, "", field, "", false);
};

paramsSearch["system"] = (query) => {
    try {
        queryHandler.getPolyTokenQuery(query, paramsSearchFields, "system", systemSearchFunc);
    } catch (e) {
        console.error(e);
        throw e;
    }
